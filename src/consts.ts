export const SITE = {
  title: "Quick.db Guide",
  description: "Official Quick.db Guide",
...
export const OPEN_GRAPH = {
  image: {
    ...
    alt: "quick.db logo with the word documentation above it",
  },
  twitter: "plexidev",
};
...
export const GITHUB_EDIT_URL = `https://github.com/plexidev/quick.db-guide/tree/master`;
